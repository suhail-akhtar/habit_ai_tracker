...
class AlarmActivity : Activity() {
    ...
    private fun dismissAlarm() {
        ...
        sendResultToFlutter("alarm_dismissed", mapOf(
    ...
    private fun scheduleSnooze(minutes: Int) {
        ...
        sendResultToFlutter("alarm_snoozed", mapOf(
    ...
    private fun sendResultToFlutter(action: String, data: Map<String, Any>) {
        try {
            ...
            val broadcastIntent = Intent("com.example.habit_ai_tracker.ALARM_ACTION").apply {
